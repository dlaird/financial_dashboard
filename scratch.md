...
confirm: forwarded emails will not contain YNAB in subject
I don't have an Anthropic API key
Yes, Michele's email will also be forwarded from Gmail
If email comes from her, memo should indicate so with an "M:" prefix, and if its from me, with a "D:" prefix.
